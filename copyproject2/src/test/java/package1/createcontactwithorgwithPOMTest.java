...
public class createcontactwithorgwithPOMTest {

	@Test
	public void creatteconactpomtest() throws IOException {
...
PropertyfileLibrary pf=new PropertyfileLibrary();
		...
		String orgname=esl.readdatafromeexcelsheet("organization", 3, 3);
